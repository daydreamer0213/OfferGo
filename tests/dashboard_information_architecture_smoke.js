...
assert.match(builder, /<a[^>]*href="\/communication\?planId=7"[^>]*>沟通清单与记录<\/a>/);
assert.doesNotMatch(builder, /<a[^>]*aria-current="page"[^>]*>沟通清单与记录<\/a>/);
...
assertCurrent(center, "/communication?planId=7&amp;batchId=19&amp;site=zhaopin", "沟通清单与记录");
